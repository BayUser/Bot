...
/* Client Variables */
const client_id = '1090346236655173712'; // Paste your bot's ID here
const client_secret = process.env.secret; // Paste your bot's secret here

/* Define app variables */
const app = Express(); // Create a web app
const port = 3030; // Port to host on
...
app.get('/', (req, res) => { // Handle incoming GET requests to http://localhost:(port)/
    res.sendFile(path.join(__dirname + 'views/index.ejs')); // Send the index.html file
});
